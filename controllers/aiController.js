 ...
 */
export const generateAITestimonialSuggestion = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Seeker)
 */
export const handleChatQuery = asyncHandler(async (req, res, next) => {
 ...
 * @access  Private (Seeker)
 */
export const getAdvancedInsights = asyncHandler(async (req, res, next) => {
